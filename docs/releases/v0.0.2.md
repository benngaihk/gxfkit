...
Bioconda `0.0.2` package files are listed by Anaconda, but clean install
...
- Bioconda `0.0.2` package files are listed in Anaconda metadata, but clean
  install verification still requires conda repodata propagation.
