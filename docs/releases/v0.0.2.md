...
- Bioconda `0.0.2` metadata is finalized with the `v0.0.2` source archive
  sha256, but the public Bioconda package still requires the upstream recipe
  update and package propagation.
