...
def main(argv: list[str]) -> int:
    ...
    require(text, "Bioconda package files are listed", errors)
    require(text, "clean install verification is still pending conda repodata propagation", errors)
    ...
    require(text, f"Bioconda `{version}` package files are listed by Anaconda", errors)
    require(text, "clean install verification is still pending conda repodata propagation", errors)
